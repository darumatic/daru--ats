...
// Deliberately no provider-default fallback: blank means "off, use the standard
// model". Defaulting this to a reasoning model would raise every install's bill
// without anyone asking for it.
function resolveAiReasoningModel(setting) {
	return asTrimmedString(setting?.aiReasoningModel);
}
...
export function serializeAdminSystemSettings(setting) {
	...
	return {
		...
		aiReasoningModel: resolveAiReasoningModel(setting),
