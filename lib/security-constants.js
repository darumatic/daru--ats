...
// Batch scoring calls the AI once per candidate, so it is bounded on three
// axes: how many pairs one request may cover, how many run at once, and how long
// the whole run may take before the remainder is reported as skipped rather than
// letting the route outlive its own request.
export const MATCH_SCORE_BATCH_MAX_CANDIDATES = parsePositiveIntEnv('MATCH_SCORE_BATCH_MAX_CANDIDATES', 25);
export const MATCH_SCORE_BATCH_CONCURRENCY = parsePositiveIntEnv('MATCH_SCORE_BATCH_CONCURRENCY', 3);
export const MATCH_SCORE_BATCH_DEADLINE_SECONDS = parsePositiveIntEnv('MATCH_SCORE_BATCH_DEADLINE_SECONDS', 100);
export const MATCH_SCORE_BATCH_RATE_LIMIT_MAX_REQUESTS = parsePositiveIntEnv(
	'MATCH_SCORE_BATCH_RATE_LIMIT_MAX_REQUESTS',
	6
);
export const MATCH_SCORE_BATCH_RATE_LIMIT_WINDOW_SECONDS = parsePositiveIntEnv(
